                ...
                <div class="ibox-content">
                    <form class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control" id="inputinvoiceno">
                        </div>
                        <div class="col-md-6">
                            <label for="inputDate" class="form-label">Invoice Date</label>
                            <input type="Date" class="form-control" id="inputdate">
                        </div>
                        <div class="col-6">
                            <label for="inputAddress" class="form-label">Sales Person</label>
                            <input type="text" class="form-control" id="inputAddress">
                        </div>
                        <div class="col-6">
                            <label for="inputAddress2" class="form-label">Terms</label>
                            <input type="text" class="form-control" id="inputAddress2" placeholder="Apartment, studio, or floor">
                        </div>
                        <div class="col-md-6">
                            <label for="inputCity" class="form-label">Currency</label>
                        </div>
                        <div class="col-md-6">
                            <label for="inputState" class="form-label">Due Date</label>
                            <input type="text" class="form-control" id="inputCState">
                        </div>
                        <div class="col-md-6">
                        </div>
                        <div class="col-md-6">
                            <label for="inputState" class="form-label">Client</label>
                            <input type="text" class="form-control" id="inputCState">
                        </div>
                        <div class="col-md-6">
                        </div>
                        <div class="col-12">
                            <label for="inputState" class="form-label">Detail Barang</label>
                        </div>
